...
# mongo_db = client['queuemaster']  # Use your database name
...
# # Set up Flask-Login and Flask-Mail
...
# # ------------------------
# # Removed WebSocket Events (Socket.IO functionality removed)
# # ------------------------
# # We have removed all socket.io code. Live updates (if needed) can be implemented using regular HTTP polling.
...
#         # Removed Socket.IO notification; updates must be polled via /display
#         # emit_queue_update()  # Optionally call this function if you want to log updates
